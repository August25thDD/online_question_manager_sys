                        ...
                        <div class="tab-pane active" id="tab-form">
                            <div class="row data-type">
                                ...
                                <c:if test="${not empty question.picture}">
                                    <div class="col-md-10 data rowHeight2x">
                                        <img src="${ctx}/upload/${question.picture}?time=<%=new Date().getTime()%>" width="100" height="80">
                                        <%--将图片地址传递到后台，方便判断原来是否有图片--%>
                                        <input type="hidden" name="picture" value="${question.picture}">
                                    </div>
                                </c:if>
                                <div class="col-md-2 title rowHeight2x">新图片</div>
                                <div class="col-md-10 data rowHeight2x">
                                    <input type="file" name="picture2">
                                </div>
                                <div class="col-md-2 title rowHeight2x">新题干描述</div>
                                <div class="col-md-10 data rowHeight2x">
