                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn btn-default" title="文件上传测试" onclick='location.href="${ctx}/store/question?operation=toFileUploadeTest"'><i class="fa fa-refresh"></i> 文件上传测试</button>
