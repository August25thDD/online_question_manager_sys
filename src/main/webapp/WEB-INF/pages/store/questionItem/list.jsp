    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/store/questionItem?operation=saveOrUpdate" method="post">
                ...
                <%--如果是从题目列表跳过来的，这个选项id是没有值的，后台就做添加业务--%>
                <%--如果是选项列表的编辑跳过来的，这个选项id是有值的，后台就做修改业务--%>
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${list}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                ...
                                <td>
                                    <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/store/questionItem?operation=toEdit&id=${o.id}&questionId=${questionId}"'>编辑</button>
