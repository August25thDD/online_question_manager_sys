...
import demo.yang.dao.store.QuestionDao;
...
public class QuestionServiceImpl implements QuestionService {
    ...
    @Override
    public void downloadExcel(ServletOutputStream os, String templatePath) {
        //获取到所有的题目
        ...
        //将这个题目信息以报表的形式写出到浏览器端
        EasyExcel.write(os,Question.class)
